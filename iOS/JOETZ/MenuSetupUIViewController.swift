...
class MenuSetupUIViewController: UIViewController
{
    ...
    override func viewDidLoad() {
        ...
        if let svc = self.slidingViewController().underLeftViewController as? MenuViewController {
            ...
            self.slidingViewController().underLeftViewController = self.storyboard?.instantiateViewControllerWithIdentifier("MenuVC") as MenuViewController
        }
